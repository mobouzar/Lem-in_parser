...
/*
**  'check_room' This function checks each room is valid
*/
...
/*
**  'check_cmd' This function checks each command is valid
*/
...
/*
**  'stock_room' This function store the rooms in the room structure if they are valid
*/
