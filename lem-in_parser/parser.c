...
/*
**  'ft_is_numbre' in this function I check if the coordinates of each room are a number
**   and I check it is a coords in 'is_cord' function
*/
...
/*
**  Here I check type of every line
**
**  Is it a comment or a command or a room or a link
*/
...
/*
**  In that function I store the file in the map structure
*/
