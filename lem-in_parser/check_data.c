...
/*
**	'ft_free_split' frees two dimensional array
**  'ft_free_rooms' frees the room structure
*/
...
/*
**  'check_link' is a function that check if two rooms are linked
*/
...
/*
**  'create_graph' is a function that create a graph and fill it
*/
...
/*
**  'read_data' is a function that read the data from the file and valid it
*/
